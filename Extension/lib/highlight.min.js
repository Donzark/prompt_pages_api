  ...
  var e = (() => {
    ...
    return (a) => {
      const l = ((e) => ({
        ...
        p = (e, t, i) => ({ className: e, begin: t, relevance: i }),
        f = {
          $pattern: /[a-z-]+/,
          keyword: "and or not only",
          attribute: t.join(" "),
...
(() => {
  var e = (() => {
    ...
    return (t) => {
      ...
      const A = c.contains.find((e) => "attr" === e.scope),
        y = Object.assign({}, A, {
          match: s.concat(l, s.lookahead(/\s*\?:/)),
        });
      return (
        c.exports.PARAMS_CONTAINS.push([c.exports.CLASS_REFERENCE, A, y]),
        (c.contains = c.contains.concat([m, b, g, y])),
        E(c, "shebang", t.SHEBANG()),
        E(c, "use_strict", {
          className: "meta",
          relevance: 10,
          begin: /^\s*['"]use strict['"]/,
